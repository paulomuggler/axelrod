...
public class OrbitPlot extends Plot<CultureDisseminationSimulation, DefaultXYDataset> {
	...
	public JFreeChart createPlot(CultureDisseminationSimulation s) {
		...
		chart = ChartFactory.createScatterPlot("Orbit Plot: " + simInfo(), "Energy/node", "Entropy/node", dataset,
	...
	public void plot() {
		...
		double[] point = { (2.*sim.nw.n_nodes*sim.nw.features + (double)sim.nw.LyapunovPotential())/sim.nw.n_nodes, 
