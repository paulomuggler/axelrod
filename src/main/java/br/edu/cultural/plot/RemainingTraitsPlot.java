...
public class RemainingTraitsPlot extends Plot<CultureDisseminationSimulation, DefaultXYDataset> {
	...
	public JFreeChart createPlot(CultureDisseminationSimulation s) {
		...
		chart = ChartFactory.createScatterPlot("Remaining Traits: "+simInfo(), "time", "Number of Remaining Traits", dataset,
